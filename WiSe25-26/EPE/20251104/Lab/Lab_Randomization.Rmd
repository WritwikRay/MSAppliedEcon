...
setwd("C:/Users/huse-admin/Dropbox/CRISTIAN/Teaching/Cursos_Meus/Teaching_2021/EPE/Lab4_Randomization")
...
That is, individuals are compared only once treatment was applied, i.e., follow-up, denoted by **round == 1**. Given the potential within locality cross-correlation, standard errors are clustered at the locality level. 



```{r, results='asis'}

ex1_lm <- lm(health_expenditures ~ treatment_locality, round == 1, data = random.df)
